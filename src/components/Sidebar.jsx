...
const Sidebar = () => {
    ...
    <div className='sidebar'>
        ...
        <div className={`sidebar-item ${activeLink === 0? "active":""}`} onClick={()=>setActiveLink(0)}>
            <Link to='/profile'className='sidebar-link'><FaUser className='icon'/>Profile</Link>
        </div>
        ...
        <Link to='/dashboard/add-contact'className='sidebar-link'><FaRegAddressCard className='icon'/>Add Contacts</Link>
        </div>
